// Mirrors server/src/utils/studentValidation.js — kept in sync by hand
// (client and server are separate packages, no shared workspace yet). If
// you touch the rules here, update that file too.
